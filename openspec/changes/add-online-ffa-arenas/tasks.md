...
- [ ] 10.1 Re-authenticate GitHub CLI, inspect the complete initial diff for secrets, create the public `Toxeydotdev/dropzone-arena` repository, commit the passing worktree, and push `main` without bypassing CI.
